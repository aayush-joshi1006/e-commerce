  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="fixed bottom-1.5 right-1.5 mb-2 inline-block rounded-full bg-[#333] px-2.5 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
      >
        <a
          className="[&>svg]:h-4 [&>svg]:w-4"
          target="_blank"
          href="https://github.com/aayush-joshi1006/e-commerce"
        >
          <svg
